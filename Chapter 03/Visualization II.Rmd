...
This is an inline r code chunk. The number of observations in the mpg dataframe is: `r nrow(mpg)`

This is code chunk. The "r" signifies that that it is and R chunk. The second gives the code chunk a name. We can also have additional arguments. For example, messages = FALSE suppresses messages.
...
How do we summarize numerical data?  
...
```{r maps example, messages = FALSE, warning = FALSE}
