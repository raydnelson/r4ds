...
*  Scatterplot of highway miles per gallon on displacement
*  Linear regression with no confidence interval 
*  Color regression line by drive train (drv)  
*  Linetype of regression line by drive train  
*  Increase the size of the regression lines  
