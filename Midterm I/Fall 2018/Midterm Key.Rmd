...
The boxplot is a graphical representation of Tukey’s five number summary. These numbers are minimum, 1st quartile, median, 3rd quartile, maximum. The minimum and maximum are the lowest and highest data points, respectively. The other values are mentioned above.
...
The means for each passenger class are much bigger than their corresponding medians. This happens when we have a positively skewed distribution with positive outliers. The large values of the outliers don't affect the median but they do affect the mean.  
