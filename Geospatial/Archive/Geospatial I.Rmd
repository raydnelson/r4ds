...
You can get the coordinates of an address from google maps. On your phone, touch and hold the location. On your computer, find the location, then right click on the location, and finally choose "what's here".

```{r Mookis hideout}
leaflet() %>% 
    addTiles() %>% 
    addMarkers(lat = 40.268831,
               lng = -111.644243,
               popup = "Nelsons")
```
...
#### Class activity for breakout groups
