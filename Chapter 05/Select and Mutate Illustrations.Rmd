...
### We often don't need to create new variables because we have functions that accomplish transformations. Two of these often used transformations are the functions scale and log.
...
## Consider now the time series data set for AirPassengers
...
### Convert AirPassengers into a data frame and use the lag and lead operators
