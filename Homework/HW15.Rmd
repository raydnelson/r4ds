...
Write a greeting function that says "good morning", "good afternoon", or "good evening", depending on the time of day. (Hint: After installing the lubridate library, then the code lubridate::now() %>% lubridate::hour() code will give you the current time.)
