...
Line 2:  Groups the observations in flights by plane using the tail number identifier  

Line 3:  Counts the number of flights make by each plane  

Line 4:  Chooses only those planes that have make more than 100 flights

Line 5 - 6:  Uses a filtering join to extract all the information from flights on aircraft that have flown more than 100 flights.  
