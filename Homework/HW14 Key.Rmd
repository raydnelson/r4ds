...
1.  Software packages often use a reference date for their date-time functions. Excel uses January 1, 1990. One alternative for R is "Unix Epoch", which is 1970-01-01. Explain how these systems represent date and date-time values as numbers.  
...
homework_graph <- "http://govfinance.byu.edu/govfinance/classes/dataScience/homework/graphs/HW12 Graph.png"
```
...
Use durations, periods, and spans to calculate your age today. The functions as.duration, as.period, years, and the %--% operator will be helpful.
