...
diamonds %>% 
  ...
  geom_point(size = 1,
             ...
             color = "red",
             alpha = 0.6) +
  geom_smooth(colour = "royalblue", se = FALSE) +
  labs(
    title = "Diamond prices form a non-linear pattern with diamond weight
    that has heteroskedastic variation.",
...
We can fix the nonlinearity and heteroskedasticity problems with a log-log transformation.
