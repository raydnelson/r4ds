...
programs_current <- c(2, 3, 1, 3, 3, 3, 2, 3, 2, 3, 2, 2, 3, 2, 3)
programs_previous <- c(1, 1, 1, 1, 2, 2, 1, 1, 2, 3, 3, 1, 1, 2, 1,
                       2, 1, 1, 3, 1, 3, 1, 1, 1, 3)
```
...
### Type of the objects that we are goingfavorite_current rdn_teaching
