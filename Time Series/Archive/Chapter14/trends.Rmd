...
```
After we have discovered the structure of our time series, it is very straight forward to fit an expoential smoothing or state-space model. This is done by using the forecast function from Rob Hyndmans forecast library. More recently, he as developed two new libraries, fable and feasts which improve upon the forecast library.
