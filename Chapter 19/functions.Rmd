...
### Evolution of S, S-Plus, and R

-   Bell Labs and Lucent Technologies wrote code in C
-   Duplication of efforts
-   Pooling of functions into libraries

### Advantages of function

-   Memorable name
-   Update code in one place
-   Eliminate copy and paste mistakes

### Write a function whenever you copy and paste a code chunk more than twice
...
### Analyze price and weight relationships for different cuts of diamonds
