...
Create a function that uses intervals to calculate the number of months left before a mortgage is paid off. Your function should take two arguments, the current date and the date that the mortgage matures. As you test your function, an easy example is to set the current date to November 18, 2019 and the maturity date to November 30, 2034. This would correspond to a 15 year mortgage.  
